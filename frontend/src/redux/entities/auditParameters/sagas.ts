...
function* editAuditParameterFailedHandler(error: Error, actionPayload: Record<string, any>) {
  yield put(editAuditParameterError({ projectId: actionPayload.projectId, errorMessage: error.message }));
