...
export const modelizeAuditStatusHistory = (
  auditStatusHistory: ApiAuditStatusHistoryType,
): AuditStatusHistoryType => {
  return {
...
export const modelizeApiAuditStatusHistoriesToByPageOrScriptIdAndAuditParametersId = (
  apiAuditStatusHistories: ApiAuditStatusHistoryType[],
): Record<string, Record<string, AuditStatusHistoryType>> => {
  return apiAuditStatusHistories.reduce(
    (
      auditStatusHistoriesByPageOrScriptIdAndAuditParametersId: Record<
        string,
        Record<string, AuditStatusHistoryType>
      >,
      apiAuditStatusHistory: ApiAuditStatusHistoryType,
    ) => ({
