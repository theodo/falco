...
def format_wpt_json_results_for_page(data):
    ...
    if lighthouse_data is not None and lighthouse_data.get("audits"):
        ...
        lighthouse_metrics = {
            "lh_metric_tti_displayed_value": lighthouse_audits["interactive"]["displayValue"],
            "lh_metric_tti_score": lighthouse_audits["interactive"]["score"],
            "lh_metric_first_contentful_paint_displayed_value": lighthouse_audits["first-contentful-paint"]["displayValue"],
            "lh_metric_first_contentful_paint_score": lighthouse_audits["first-contentful-paint"]["score"],
            "lh_metric_speed_index_displayed_value": lighthouse_audits["speed-index"]["displayValue"],
            "lh_metric_speed_index_score": lighthouse_audits["speed-index"]["score"],
            "lh_metric_first_meaningful_paint_displayed_value": lighthouse_audits["first-meaningful-paint"]["displayValue"],
            "lh_metric_first_meaningful_paint_score": lighthouse_audits["first-meaningful-paint"]["score"],
            "lh_metric_first_cpu_idle_displayed_value": lighthouse_audits["first-cpu-idle"]["displayValue"],
            "lh_metric_first_cpu_idle_score": lighthouse_audits["first-cpu-idle"]["score"],
            "lh_metric_max_potential_first_input_delay_displayed_value": lighthouse_audits["max-potential-fid"]["displayValue"],
            "lh_metric_max_potential_first_input_delay_score": lighthouse_audits["max-potential-fid"]["score"],
        }
    wpt_metrics = {
        ...
        "wpt_metric_repeat_view_tti": data["median"]["repeatView"].get("TimeToInteractive")
        or data["median"]["repeatView"].get("FirstInteractive")
        or data["median"]["repeatView"].get("LastInteractive"),
        "wpt_metric_first_view_speed_index": data["median"]["firstView"].get("SpeedIndex"),
        "wpt_metric_repeat_view_speed_index": data["median"]["repeatView"].get("SpeedIndex"),
        "wpt_metric_first_view_first_paint": data["median"]["firstView"].get("firstPaint"),
        "wpt_metric_repeat_view_first_paint": data["median"]["repeatView"].get("firstPaint"),
        "wpt_metric_first_view_first_meaningful_paint": data["median"]["firstView"].get("firstMeaningfulPaint"),
        "wpt_metric_repeat_view_first_meaningful_paint": data["median"]["repeatView"].get("firstMeaningfulPaint"),
        "wpt_metric_first_view_first_contentful_paint": data["median"]["firstView"].get("firstContentfulPaint"),
        "wpt_metric_repeat_view_first_contentful_paint": data["median"]["repeatView"].get("firstContentfulPaint"),
        "wpt_metric_first_view_load_time": data["median"]["firstView"].get("loadTime"),
        "wpt_metric_repeat_view_load_time": data["median"]["repeatView"].get("loadTime"),
        "wpt_metric_first_view_time_to_first_byte": data["median"]["firstView"].get("TTFB"),
        "wpt_metric_repeat_view_time_to_first_byte": data["median"]["repeatView"]["TTFB"],
        "wpt_metric_first_view_visually_complete": data["median"]["firstView"].get("visualComplete"),
        "wpt_metric_repeat_view_visually_complete": data["median"]["repeatView"].get("visualComplete"),
        "wpt_metric_lighthouse_performance": data["median"]["firstView"].get("lighthouse.Performance"),
